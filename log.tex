...
\def\GitHub{https://github.com/Nasumica/LukaMaturski/blob/main/}
...
Zbog svoje va{\zv}nosti spada u grupu {\sl elementarnih funkcija}, zajedno sa eksponencijalnom i 
trigonometrijskim funkcijama. Opisane su {\nj}ene osobine i dati su primeri {\nj}ene upotrebe,
...
\link{\GitHub log.pdf}{{\sf GitHub} --- Luka S. Ne{\sv}i{\cc} --- Maturski rad --- Logaritam}
