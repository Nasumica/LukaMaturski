...
\def\link#1#2{\item\href{#1}{#2}\hfill\break\href{#1}{\footnotesize\texttt{#1}}}
...
\begin{enumerate}[parsep=0cm]
  ...
  \item \leavevmode\kern-5pt\raise-\down\hbox{\includegraphics[height=\godim]{GO.png}} (programming language) --- Google
