...
Pomo{\cc}u {\nj}ih se mogu izra{\cv}unati vrednosti binarnog, odnosno, de\-kad\-nog logaritma
$$
\logtwo x=\frac{\ln x}{\ln2},\qquad \logten x=\frac{\ln x}{\ln 10}.
$$
...
sta{\nj}a na ra{\cv}unu,
\dots), budu $\ell$ za brojnu osnovu $b$, prati takozvani {\sl Benfordov zakon\/} (Frank Benford), i iznosi
...
\begin{enumerate}[parsep=0cm]
  ...
  \item \leavevmode\kern-5pt\raise-\down\hbox{\includegraphics[height=\godim]{GOc.png}} (programming language) --- Google
