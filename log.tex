...
\danger
Treba biti oprezan kod kori{\sv}{\cc}e{\nj}a svih ovih jednakosti 
i uvek treba proveriti interval u kome se ne{\sv}to ra{\cv}una.
Na primer, iz jednakosti \eqref{eq:lnmul} sledi $\log x^2=2\log x$, {\sv}to je ispravno za $x>0$.
Ina{\cv}e, $\log x^2=2\log|x|$, za bilo koje $x\ne0$.
...
Mo{\zv}e se dobiti i bitna jednakost
\begin{equation}
