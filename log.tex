...
\odg Kako je $\ln \e=1$, a koriste{\cc}i jednakost za logaritam proizvoda \eqref{eq:lnmul} 
...
\odg $d=\lfloor\logten 2^{128}\rfloor+1=\lfloor 128\logten 2\rfloor+1=\lfloor 38.5318\rfloor+1=38+1=\ram{39}.$


\subsection{Izvod}
\zad Odredi izvod funkcije $f(\alpha)=\log_3(\cos\alpha)$.
\odg Kako je izvod $\cos\alpha$ jednak $-\sin\alpha$ i iz jednakosti 
...
\odg Kvadratni koren se mo{\zv}e direktno {\cv}itati sa logaritmara ako {\sl u glavi\/} izvr{\sv}imo 
