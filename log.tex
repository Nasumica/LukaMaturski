...
za $\sin x$ i $\cos x$, koje se dobijaju iz Meklorenovog\index{Mekloren} (Cailean MacLabhruinn) reda:
...
Na primer,
$$
\log_{2+i}(3+4i)=2, \qquad \log_i\e=\frac{2}{i\pi},\qquad \logtwo(-4)=2+i\pi.
$$
