...
% \def\QED{\qed\index{quod erat demonstrandum $(\square)$}}
\def\QED{\qed}
\def\th{t_{1/2}}
\def\um#1{\,{\rm#1}}
...
Funkcija ima jednu {\sl nulu}, uvek za $x=1$. Kada je $x=0$, $y=-\infty$\index{beskona{\cv}nost $(\infty)$}
ako je $b>1$, odnosno, $y=+\infty$ za $b<1$.
$$
...
$$
koji mo{\zv}e biti predstav{\lj}en kao
...
\end{alignat*}
a kako je Ojlerova formula\index{Ojlerova formula}
\begin{equation}\label{eq:euler}
  ...
  ,
\end{equation} 
onda se iz {\nj}e i iz jednakosti \eqref{eq:lnmul} i \eqref{eq:powb} dobija\index{ln@$\ln$}
\begin{equation}
...
Iz Ojlerove formule \eqref{eq:euler} sledi i
