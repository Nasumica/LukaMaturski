...
$$
\slika{\hbox to 0pt{\hss\hbox{\includegraphics[width=\zxscreen]{ln-prog.png}\enspace
  \includegraphics[width=\zxscreen]{ln-run.png}}\hss}}{\href{https://fuse-emulator.sourceforge.net/}{\textsf{ZX Spectrum}} \href{\GitHubRaw ln.z80}{\BASIC} program.}
$$

% https://github.com/Nasumica/LukaMaturski/raw/refs/heads/main/ln.sna
