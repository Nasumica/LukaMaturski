...
$$
\slika{\hbox to 0pt{\hss\hbox{\includegraphics[width=\zxscreen]{eps/ln-prog.png}\enspace
  \includegraphics[width=\zxscreen]{eps/ln-run.png}}\hss}}{\textsf{ZX Spectrum} \href{\GitHub ln.sna}{\BASIC} program.}
$$
