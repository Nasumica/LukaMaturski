...
\underbrace{1\.09861228866}_{\hbox{\scriptsize ta{\cv}ne cifre}}\!9726\ldots$$
...
\slika{\hbox to 0pt{\hss\hbox{\includegraphics[width=\zxscreen]{ln-prog.png}\enspace
  \includegraphics[width=\zxscreen]{ln-run.png}}\hss}}{\href{https://fuse-emulator.sourceforge.net/}{\textsf{ZX Spectrum}} \href{\GitHub ln.sna}{\BASIC} program.}
$$
