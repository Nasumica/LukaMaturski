...
Da bi $q=s+v$ bio kvaternion, mora biti $v\ne0$, ina{\cv}e je $q$ obi{\cv}an realan broj, 
...
Tri\-gono\-metrijske i hiperboli{\cv}ne funkcije mogu se izraziti pomo{\cc}u eksponencijalne,
